...
const addProduct = asyncHandler(async (req: AuthRequest, res: Response) => {
  try {
    const { name, description, price, category, quantity, brand } = req.fields as ProductFields;
...
const addProductReview = asyncHandler(async (req: AuthRequest, res: Response) => {
  try {
